...
export function SearchHeader({ icons, categories }: SearchHeaderProps) {
  ...
  return (
    <div className="relative z-10">
      {/* Header */}
      <div className="border-b border-gray-200 dark:border-gray-800 bg-white/80 dark:bg-[#0a0a0a]/80 backdrop-blur-xl sticky top-0 z-20">
        <div className="max-w-7xl mx-auto px-6 py-6">
          <div className="flex items-center justify-between mb-6">
            <div className="flex items-center gap-4">
              ...
              <div>
                ...
                <p className="text-sm text-gray-600 dark:text-gray-400">Open-source icon library for Solana</p>
              </div>
            </div>
            <div className="flex items-center gap-3">
              <a 
                ...
                target="_blank"
                className="px-4 py-2 bg-gray-100 hover:bg-gray-200 dark:bg-gray-800 dark:hover:bg-gray-700 text-gray-900 dark:text-white rounded-lg text-sm transition flex items-center gap-2"
              >
              ...
              <code className="px-4 py-2 bg-gray-100 dark:bg-gray-900 text-gray-900 dark:text-gray-300 rounded-lg text-sm font-mono">
                npm i solana-icons
              </code>
            </div>
          </div>
          ...
          <div className="relative">
            ...
            <input
              ...
              className="w-full pl-12 pr-4 py-4 bg-gray-50 dark:bg-gray-900/50 border border-gray-200 dark:border-gray-800 rounded-xl text-gray-900 dark:text-white placeholder-gray-400 dark:placeholder-gray-500 focus:outline-none focus:ring-2 focus:ring-purple-500 focus:border-transparent transition"
            />
          </div>
      ...
      <div className="max-w-7xl mx-auto px-6 py-8">
        {iconCount === 0 ? (
          <div className="text-center py-20">
            <p className="text-gray-600 dark:text-gray-400 text-lg">No icons found</p>
            <p className="text-gray-400 dark:text-gray-600 text-sm mt-2">Try a different search or category</p>
          </div>
        ) : (
          <>
